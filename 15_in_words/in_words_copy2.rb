  ...
  def in_words
    ...
    def thousands(number)
      ...
      if number >= 1_000_000_000_000
        no_in_words += thousands(number%1_000_000_000_000) + " trillion"
      elsif number >= 1_000_000_000
        no_in_words += thousands(number%1_000_000_000) + " billion"
      elsif number >= 1_000_000
        no_in_words += thousands(number%1_000_000) + " million"
      elsif number >= 1_000
        no_in_words += thousands(number/1_000) + " thousand"
      elsif number < 1000 && number > 
